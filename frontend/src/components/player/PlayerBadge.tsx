  ...
  return (
    ...
    >
      <div className="">
        ...
        <div
          className={`flex flex-row gap-2 ${variant === "default" && !mirrored && "justify-start"}`}
        >
          {player?.title && (
            <div
            ...
            >
              <p
                className={`${variant === "default" ? "text-3xl font-bold" : "text-base font-bold"} mx-auto text-center`}
              >
                {player?.title}
              </p>
            </div>
