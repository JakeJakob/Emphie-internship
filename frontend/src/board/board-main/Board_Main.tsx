  ...
  return (
    <div className=" w-full h-[720px]">
      <div className="grid grid-cols-3 mt-4">
        <div className="header-item text-white py-2 text-center bg-black bg-opacity-20 font-bold text-3xl">
          Runda 1
        </div>
        <div className="header-item text-white py-2 text-center bg-black bg-opacity-30 font-bold text-3xl">
          Runda 2
        </div>
        <div className="header-item text-white py-2 text-center bg-black bg-opacity-20 font-bold text-3xl">
          Runda 3
